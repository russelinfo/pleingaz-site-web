      ...
      <div className="relative container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 z-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-100 leading-relaxed">
            Votre partenaire de confiance pour la livraison rapide, 
            sécurisée et fiable de bouteilles de gaz, directement chez vous.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/a-propos" className="hover:text-gray-300 transition">À propos</a></li>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-2">
              <Phone size={18} /> <span>+237 6 99 99 99 99</span>
            </li>
            <li className="flex items-center gap-2">
