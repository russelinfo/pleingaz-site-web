...
const pillars = [
  {
    ...
    title: 'Santé',
    desc: 'Réduire les maladies liées à la fumée en proposant une énergie propre.',
  },
  {
     ...
     <div className='flex flex-col lg:flex-row items-start gap-16'>
      ...
      >
       ...
       <p className='text-gray-700 mb-4'>
        ...
        en garantissant <b>sécurité</b>, <b>proximité</b> et{' '}
        <b>disponibilité permanente</b>.
       </p>
       <p className='text-gray-700 mb-8'>
        En plus du gaz, PleinGaz propose une gamme complète d’
        <b>accessoires</b> : plaques à gaz, détendeurs, tuyaux et autres
       ...
       <p className='text-gray-700 mb-8'>
        ...
        marques ont été satisfaites et continuer à faire confiance à notre
        marque. Cela a été possible en raison de facteurs tels que la
        fiabilité de la quantité achetée, la sécurité de nos bouteilles.
       </p>
      </motion.div>
